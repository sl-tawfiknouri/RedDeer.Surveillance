...
namespace Domain.Core.Markets.Collections
{
    ...
    /// </summary>
    public class FixedIncomeInterDayTimeBarCollection
    {
        public FixedIncomeInterDayTimeBarCollection(
            Market exchange,
            DateTime epoch,
            IReadOnlyCollection<FixedIncomeInstrumentInterDayTimeBar> securities)
        {
            this.Exchange = exchange;
            this.Epoch = epoch;
            this.Securities = securities ?? new List<FixedIncomeInstrumentInterDayTimeBar>();
        }
        ...
        /// </summary>
        public IReadOnlyCollection<FixedIncomeInstrumentInterDayTimeBar> Securities { get; }
