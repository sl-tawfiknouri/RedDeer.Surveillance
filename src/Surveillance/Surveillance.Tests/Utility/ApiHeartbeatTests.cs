...
namespace Surveillance.Tests.Utility
{
    ...
    public class ApiHeartbeatTests
    {
        ...
        public void Constructor_NullExchangeRateApi_IsExceptional()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ApiHeartbeat(null, _marketApi, _ruleApi, _logger));
        }
        ...
        {
            // ReSharper disable once ObjectCreationAsStatement
            Assert.Throws<ArgumentNullException>(() => new ApiHeartbeat(_exchangeRateApi, null, _ruleApi, _logger));
        }
        ...
        {
            // ReSharper disable once ObjectCreationAsStatement
            Assert.Throws<ArgumentNullException>(() => new ApiHeartbeat(_exchangeRateApi, _marketApi, null, _logger));
        }

        [Test]
        public async Task HeartsBeating_AllReturnTrue_IsTrue()
        {
            var heartbeat = new ApiHeartbeat(_exchangeRateApi, _marketApi, _ruleApi, _logger);
