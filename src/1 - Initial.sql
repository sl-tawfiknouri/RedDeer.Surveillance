...
CREATE TABLE SystemProcessOperation(Id NVARCHAR(255) NOT NULL PRIMARY KEY, SystemProcessId NVARCHAR(255) NOT NULL, OperationStart DATETIME NOT NULL, OperationEnd DATETIME NOT NULL, OperationState INT NOT NULL, FOREIGN KEY (SystemProcessId) REFERENCES SystemProcess(Id) ,FOREIGN KEY (OperationState) REFERENCES SystemProcessOperationState(Id));
...
CREATE TABLE SystemProcessOperationDistributeRule(Id NVARCHAR(255) NOT NULL PRIMARY KEY, SystemProcessOperationId NVARCHAR(255) NOT NULL, ScheduleRuleInitialStart DATETIME NOT NULL, ScheduleRuleInitialEnd DATETIME NOT NULL, RulesDistribributed NVARCHAR(1024) NULL, FOREIGN KEY (SystemProcessOperationId) REFERENCES SystemProcessOperation(Id));
...
CREATE TABLE SystemProcessOperationRuleRun(Id NVARCHAR(255) NOT NULL PRIMARY KEY, SystemProcessOperationId NVARCHAR(255) NOT NULL, RuleDescription NVARCHAR(1024) NOT NULL, RuleVersion NVARCHAR(255) NOT NULL, ScheduleRuleStart DATETIME NOT NULL, ScheduleRuleEnd DATETIME NOT NULL, Alerts INT NOT NULL, FOREIGN KEY (SystemProcessOperationId) REFERENCES SystemProcessOperation(Id));
