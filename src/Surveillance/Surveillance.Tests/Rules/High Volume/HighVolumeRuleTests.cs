...
namespace Surveillance.Tests.Rules.High_Volume
{
    ...
    public class HighVolumeRuleTests
    {
        ...
        public void Constructor_ConsidersNullParameters_ToBeExceptional()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new HighVolumeRule(null, _ruleCtx, _alertStream, _factory, _logger));
        }
        ...
        {
            // ReSharper disable once ObjectCreationAsStatement
            Assert.Throws<ArgumentNullException>(() => new HighVolumeRule(_parameters, null, _alertStream, _factory, _logger));
        }
        ...
        {
            // ReSharper disable once ObjectCreationAsStatement
            Assert.Throws<ArgumentNullException>(() => new HighVolumeRule(_parameters, _ruleCtx, _alertStream, _factory, null));
        }

        [Test]
        public void Eschaton_UpdatesAlertCountAndEndsEvent_ForCtx()
        {
            var highVolumeRule = new HighVolumeRule(_parameters, _ruleCtx, _alertStream, new UniverseMarketCacheFactory(), _logger);
