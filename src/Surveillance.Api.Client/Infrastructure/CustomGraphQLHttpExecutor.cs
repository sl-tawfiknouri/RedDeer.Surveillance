...
namespace Surveillance.Api.Client.Infrastructure
{
    ...
    /// I've copied the code so that I could use a custom HttpMessageHandler for testing purposes (Jezz)
    /// https://github.com/sahb1239/SAHB.GraphQLClient/blob/develop/src/SAHB.GraphQLClient/Executor/GraphQLHttpExecutor.cs
    /// </summary>
    public class CustomGraphQLHttpExecutor : IGraphQLHttpExecutor
    {
        ...
        /// </summary>
        public CustomGraphQLHttpExecutor(HttpMessageHandler handler = null)
        {
            // Add httpClient
        ...
        public ILoggerFactory LoggerFactory
        {
            ...
            set
            {
                ...
                {
                    Logger = _loggerFactory.CreateLogger<CustomGraphQLHttpExecutor>();
                }
            }
        }
        ...
        /// </summary>
        private ILogger<CustomGraphQLHttpExecutor> Logger { get; set; }
