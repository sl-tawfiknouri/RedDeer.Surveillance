...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Buy Sell orders with losses within window yields zero alerts", null, new string[] {
                        "highprofit",
                        "highprofitabsolute",
                        "highprofitabsolutenonsensitive"});
#line 49
