namespace Surveillance.DataLayer.Tests.Aurora.Rules
{
    ...
    public class RuleBreachRepositoryTests
    {
        ...
        public async Task Get_Duplicates_When_Duplicates_Reports_AsExpected()
        {
            ...
            var caseMessage2 = new RuleBreach(
                101,
                "rule-1",
                "correlation-id",
                true,
            ...
            var breaches2 = Enumerable.Range(0, 100).Select(i => new RuleBreachOrder(result2.ToString(), i.ToString()))
                .ToList();
        ...
        [Test]
        [Explicit("db integration")]
        public async Task Get_Duplicates_When_Many_BackTest_Duplicates_Reports_AsExpected()
        {
            var connectionStringFactory = new ConnectionStringFactory(this._configuration);
            var repo = new RuleBreachRepository(connectionStringFactory, this._logger);
            ...
            var caseMessage3 = new RuleBreach(
                300,
                "rule-5",
                "correlation-id",
                true,
            ...
            var breaches3 = Enumerable.Range(0, 100).Select(i => new RuleBreachOrder(result3.ToString(), i.ToString()))
                .ToList();
            await orderRepo.Create(breaches3);

            var result = await repo.HasDuplicateBackTest(result1.ToString(), "correlation-id");
        ...
        public void Setup()
        {
            ...
            this._logger = new NullLogger<RuleBreachRepository>();
        }
    }
}