...
CREATE TABLE instrumenttypes(Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Descriptions NVARCHAR);
INSERT INTO instrumenttypes VALUES (0, "None"), (1, "Market"), (2, "Limit");
