...
START TRANSACTION;
 ...
 CREATE TABLE SystemProcessOperationDataSynchroniserRequest (Id INT auto_increment PRIMARY KEY NOT NULL, SystemProcessOperationId INT NOT NULL, QueueMessageId NVARCHAR(255) NULL, RuleRunId NVARCHAR(255) NULL, FOREIGN KEY (SystemProcessOperationId) REFERENCES SystemProcessOperation(Id));
