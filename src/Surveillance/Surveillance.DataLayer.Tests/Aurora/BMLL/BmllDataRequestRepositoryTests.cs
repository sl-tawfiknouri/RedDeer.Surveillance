...
namespace Surveillance.DataLayer.Tests.Aurora.BMLL
{
    ...
    public class BmllDataRequestRepositoryTests
    {
        ...
        public void Ctor_DbConnectionFactoryNull_IsExceptional()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new RuleRunDataRequestRepository(null, _logger));
        }
        ...
        {
            // ReSharper disable once ObjectCreationAsStatement
            Assert.Throws<ArgumentNullException>(() => new RuleRunDataRequestRepository(_connectionStringFactory, null));
        }
        ...
        public async Task DataRequestsForSystemOperation_UpdateToCompleteWithDuplicates_UpdatesRelevantRequests()
        {
            ...
            var dataRequests = 
                (await repo.DataRequestsForSystemOperation(id))
                    .Where(_ => _.MarketIdentifierCode == "TESTME")
                    .ToList();
            ...
            var oneDataRequest = new MarketDataRequest[] {dataRequests.FirstOrDefault()};
