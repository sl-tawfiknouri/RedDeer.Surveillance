namespace Surveillance.DataLayer.Tests.Aurora.Files
{
    ...
    public class FileUploadOrderAllocationsRepositoryTests
    {
        ...
        {
            var repository = new FileUploadOrderAllocationRepository(this._connectionFactory, this._logger);
        ...
        public void Setup()
        {
            ...
            this._logger = new NullLogger<FileUploadOrderAllocationRepository>();
        }
    }
}