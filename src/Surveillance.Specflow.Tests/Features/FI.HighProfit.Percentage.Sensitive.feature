...
Scenario: Buy Sell orders within time window yields two alerts
	...
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume | CleanOrDirty |
	| UKGovtBondSecondaryMarket     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 100           | 100          | Clean |
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          | Clean |
	When I run the fixed income high profit rule
...
Scenario: Buy Sell orders next day but within time window yields two alerts
	...
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume | CleanOrDirty |
	| UKGovtBondSecondaryMarket     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 100           | 100          | Clean |
	| UKGovtBondSecondaryMarket     | 1       | 01/02/2018 09:55:00 |            |             |              |               | 01/02/2018 09:55:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          | Clean |
	When I run the fixed income high profit rule
	Then I will have 3 fixed income high profit alerts
...
Scenario: Buy Sell orders before market open within time window yields two alerts
	...
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 05:55:00 |            |             |              |               | 01/01/2018 05:55:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          | Clean |
	When I run the fixed income high profit rule
	Then I will have 3 fixed income high profit alerts
...
Scenario: Buy Sell orders after market close within time window yields two alerts
	...
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 19:55:00 |            |             |              |               | 01/01/2018 19:55:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          | Clean |
	When I run the fixed income high profit rule
	Then I will have 3 fixed income high profit alerts
...
Scenario: Buy Sell orders with losses within time window yields zero alerts
	...
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume | CleanOrDirty |
	| UKGovtBondSecondaryMarket     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 100           | 100          | Clean |
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | SELL      | GBX      |            | 9.5              | 100         | 100          | Clean |
	When I run the fixed income high profit rule
	Then I will have 0 fixed income high profit alerts
...
Scenario: Buy Sell partially filled orders within time window yields two alerts
	...
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | SELL      | GBX      |            | 12               | 1000          | 100          | Clean |
	When I run the fixed income high profit rule
	Then I will have 3 fixed income high profit alerts
...
Scenario: Buy Sell unfilled orders within time window yields zero alerts
	...
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 09:55:00 |            |             |              |               |				       | MARKET | SELL      | GBX      |            | 12               | 100           |	          | Clean |
	When I run the fixed income high profit rule
	Then I will have 0 fixed income high profit alerts
...
Scenario: Buy Sell many orders within time window yields four alerts
	...
	| UKGovtBondSecondaryMarket       | 3       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          | Clean |
	| UKGovtBondSecondaryMarket     | 4       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 100           | 100          | Clean |
	| UKGovtBondSecondaryMarket     | 5       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          | Clean |
	When I run the fixed income high profit rule
	Then I will have 3 fixed income high profit alerts
...
Scenario: Buy just buy orders within time window yields two alerts
	...
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume | CleanOrDirty |
	| UKGovtBondSecondaryMarket     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 100           | 100          | Clean |
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | BUY      | GBX      |            | 12               | 100           | 100          | Clean |
	And With the fixed income intraday market data :
	| SecurityName | Epoch	             | Bid | Ask | Price | Currency | Volume      |
	| UKGovtBondSecondaryMarket     | 01/01/2018 09:30:00 | 101 | 101 | 101   | GBX      | 10000		  |
	When I run the fixed income high profit rule
...
Scenario: Cover just cover orders within time window yields two alerts
	...
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | COVER      | GBX      |            | 12               | 100           | 100          | Clean |
	And With the fixed income intraday market data :
	| SecurityName | Epoch	             | Bid | Ask | Price | Currency | Volume      |
	| UKGovtBondSecondaryMarket     | 01/01/2018 09:30:00 | 101 | 101 | 101   | GBX      | 10000		  |
	When I run the fixed income high profit rule
...
Scenario: Short just short orders within time window yields zero alerts
	...
	| UKGovtBondSecondaryMarket     | 1       | 01/01/2018 09:55:00 |            |             |              |               | 01/01/2018 09:55:00 | MARKET | SHORT      | GBX      |            | 12               | 100           | 100          | Clean |
	And With the fixed income intraday market data :
	| SecurityName | Epoch	             | Bid | Ask | Price | Currency | Volume      |
	| UKGovtBondSecondaryMarket     | 01/01/2018 09:30:00 | 101 | 101 | 101   | GBX      | 10000		  |
	When I run the fixed income high profit rule
...
Scenario: Buy order with increase in market price (bmll) yields one alert
	...
	And With the fixed income intraday market data :
	| SecurityName | Epoch	             | Bid | Ask | Price | Currency | Volume      |
	| UKGovtBondSecondaryMarket     | 01/01/2018 09:30:00 | 120 | 120 | 120   | GBX      | 10000		  |
	When I run the fixed income high profit rule
