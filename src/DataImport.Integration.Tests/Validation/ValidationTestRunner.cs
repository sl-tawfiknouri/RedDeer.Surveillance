    ...
    public class ValidationTestRunner
    {
                                                ...
                                                new List<Func<Order, bool>>
                                                    {
                                                        a => a.OrderId == "943191f1-4144-4b0a-8a48-3c00a2ee20e7"
                                                             ...
                                                             && a.Instrument.Identifiers.BloombergTicker
                                                             == "ITRK LN Equity"
                                                             ...
                                                             && a.OrderOptionExpirationDate.Value == new DateTime(
                                                                 2018,
                                                                 01,
                                                                 18,
                                                                 09,
                                                                 0,
                                                                 0)
                                                             && a.OrderOptionEuropeanAmerican
                                                             == OptionEuropeanAmerican.EUROPEAN
                                                             && a.DealerOrders.Count == 1
                                                             && a.DealerOrders.First().DealerOrderId == "100b"
                                                             && a.DealerOrders.First().PlacedDate == new DateTime(
                                                                 2018,
                                                                 01,
                                                                 18,
                                                                 9,
                                                                 0,
                                                                 0)
                                                             && a.DealerOrders.First().BookedDate == new DateTime(
                                                                 2018,
                                                                 01,
                                                                 18,
                                                                 9,
                                                                 0,
                                                                 0)
                                                             && a.DealerOrders.First().AmendedDate == new DateTime(
                                                                 2018,
                                                                 01,
                                                                 18,
                                                                 9,
                                                                 0,
                                                                 0) && a.DealerOrders.First().RejectedDate == null
                                                             && a.DealerOrders.First().CancelledDate == null
                                                             && a.DealerOrders.First().FilledDate == new DateTime(
                                                                 2018,
                                                                 01,
                                                                 18,
                                                                 9,
                                                                 0,
                                                                 0) && a.DealerOrders.First().DealerId == "RYAN"
                                                             && a.DealerOrders.First().DealerName == "Ryan Trenchard"
                                                             && a.DealerOrders.First().Notes
                                                             == "Trade within 1% of vwap"
                                                             && a.DealerOrders.First().DealerCounterParty
                                                             == "Barclays Capital"
                                                             && a.DealerOrders.First().OrderType == OrderTypes.MARKET
                                                             && a.DealerOrders.First().OrderDirection
                                                             == OrderDirections.BUY
                                                             && a.DealerOrders.First().Currency.Code == "GBP"
                                                             && a.DealerOrders.First().SettlementCurrency.Code == "CNY"
                                                             && a.DealerOrders.First().CleanDirty
                                                             == OrderCleanDirty.CLEAN
                                                             && a.DealerOrders.First().AccumulatedInterest == 1
                                                             && a.DealerOrders.First().LimitPrice.Value.Value == 10m
                                                             && a.DealerOrders.First().AverageFillPrice.Value.Value
                                                             == 100m && a.DealerOrders.First().OrderedVolume == 50
                                                             && a.DealerOrders.First().FilledVolume == 200
                                                             && a.DealerOrders.First().OptionStrikePrice == 30
                                                             && a.DealerOrders.First().OptionExpirationDate
                                                             == new DateTime(2018, 01, 18, 9, 0, 0)
                                                             && a.DealerOrders.First().OptionEuropeanAmerican
                                                             == OptionEuropeanAmerican.AMERICAN,
                                                        a => a.OrderId == "9e03994a-c681-4851-b0fa-0da721c0a880"
                                                             ...
                                                             && a.OrderOptionExpirationDate.Value == new DateTime(
                                                                 ...
                                                                 09,
                                                                 0,
                                                                 0) && a.OrderOptionEuropeanAmerican
                                                             == OptionEuropeanAmerican.EUROPEAN,
        ...
        public void RunAllValidationTests()
        {
            ...
            foreach (var file in this._validationFiles)
            {
                ...
                foreach (var cond in file.RowAssertions) Assert.IsTrue(ordersList.Any(cond));
            }
        }
