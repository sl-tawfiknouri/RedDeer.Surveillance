...
CREATE TABLE IF NOT EXISTS Migrations(Id INT NOT NULL PRIMARY KEY, Description NVARCHAR(255) NOT NULL, ExecutedOn DATETIME NOT NULL, Complete BIT NOT NULL);
INSERT INTO Migrations VALUES(1, "Initial.sql", now(), 0);
...
UPDATE Migrations SET Complete = 1 WHERE Id = 1;
