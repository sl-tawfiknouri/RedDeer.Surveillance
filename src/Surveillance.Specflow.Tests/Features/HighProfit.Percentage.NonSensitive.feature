...
Scenario: Buy Sell orders next day but within the time window yields two alerts
	...
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 100           | 100          |
	| Vodafone     | 1       | 01/02/2018 09:31:00 |            |             |              |               | 01/02/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy Sell orders before market open within the time window yields two alerts
	...
	| Vodafone     | 1       | 01/01/2018 05:31:00 |            |             |              |               | 01/01/2018 05:31:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy Sell orders after market close within the time window yields two alerts
	...
	| Vodafone     | 1       | 01/01/2018 19:31:00 |            |             |              |               | 01/01/2018 19:31:00 | MARKET | SELL      | GBX      |            | 12               | 100           | 100          |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy Sell partially filled orders within the time window yields two alerts
	...
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000          | 100          |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy Sell unfilled orders within the time window yields zero alerts
	...
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               |					   | MARKET | SELL      | GBX      |            | 12               | 100           |	          |
	When I run the high profit rule
	Then I will have 0 high profit alerts
