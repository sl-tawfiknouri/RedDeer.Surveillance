...
CREATE TABLE IF NOT EXISTS Migrations(Id INT NOT NULL PRIMARY KEY, Description NVARCHAR(255) NOT NULL, ExecutedOn DATETIME NOT NULL);
...
INSERT INTO SystemProcessType VALUES(1, "Data Import Service");
