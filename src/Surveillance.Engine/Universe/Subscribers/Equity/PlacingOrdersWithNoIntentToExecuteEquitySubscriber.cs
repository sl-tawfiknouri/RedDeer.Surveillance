...
namespace Surveillance.Engine.Rules.Universe.Subscribers.Equity
{
    public class PlacingOrdersWithNoIntentToExecuteEquitySubscriber : IPlacingOrdersWithNoIntentToExecuteEquitySubscriber
    {
            ...
            IUniverseDataRequestsSubscriber dataRequestSubscriber)
        {
            ...
            {
                _logger.LogError("tried to schedule a placing orders with no intent to execute rule execution with no parameters set");
                opCtx.EventError("tried to schedule a placing orders with no intent to execute rule execution with no parameters set");
            }
