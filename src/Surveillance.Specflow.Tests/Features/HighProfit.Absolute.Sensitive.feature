...
Scenario: Buy Sell orders next day but within time window yields two alerts
	...
	| 25           |                      | 1000               | GBX                | false                            | true | false |
	And I have the orders for a universe from 01/01/2018 to 03/01/2018 :
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/02/2018 09:31:00 |            |             |              |               | 01/02/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000           | 1000        |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy Sell orders before market open within time window yields two alerts
	Given I have the orders for a universe from 01/01/2018 to 03/01/2018 :
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 06:30:00 |            |             |              |               | 01/01/2018 06:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/01/2018 06:31:00 |            |             |              |               | 01/01/2018 06:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000           | 1000        |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy Sell orders after market close within time window yields two alerts
	Given I have the orders for a universe from 01/01/2018 to 03/01/2018 :
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 19:30:00 |            |             |              |               | 01/01/2018 19:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/01/2018 19:31:00 |            |             |              |               | 01/01/2018 19:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000           | 1000        |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy Sell orders with losses within time window yields zero alerts
	...
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SELL      | GBX      |            | 1               | 1000           | 1000        |
	When I run the high profit rule
	Then I will have 0 high profit alerts
...
Scenario: Buy Sell partially filled orders within time window yields two alerts
	...
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 10000          | 1000        |
	When I run the high profit rule
	Then I will have 3 high profit alerts

Scenario: Buy Sell orders within time window yields zero alerts
	Given I have the orders for a universe from 01/01/2018 to 03/01/2018 :
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               |					   | MARKET | BUY       | GBX      |            | 10               | 1000           |		      |
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               |					   | MARKET | SELL      | GBX      |            | 12               | 1000           |		      |
	When I run the high profit rule
	Then I will have 0 high profit alerts
...
Scenario: Buy Sell many orders within time window yields four alerts
	...
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000           | 1000        |
	| Nvidia       | 2       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Nvidia       | 3       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000           | 1000        |
	| Barclays     | 4       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Barclays     | 5       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000           | 1000        |
	When I run the high profit rule
...
Scenario: Buy Sell orders different exchange within time window yields two alerts
	Given I have the orders for a universe from 01/01/2018 to 03/01/2018 :
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Nvidia     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Nvidia     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SELL      | GBX      |            | 12               | 1000           | 1000        |
	When I run the high profit rule
	Then I will have 3 high profit alerts
...
Scenario: Buy just buy orders within time window yields two alerts
	...
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | BUY       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | BUY      | GBX      |            | 12               | 1000           | 1000        |
...
Scenario: Cover just cover orders within time window yields two alerts
	Given I have the orders for a universe from 01/01/2018 to 03/01/2018 :
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | COVER       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | COVER       | GBX      |            | 12               | 1000           | 1000        |
	And With the intraday market data :
	| SecurityName | Epoch	             | Bid | Ask | Price | Currency | Volume      |
	| Vodafone     | 01/01/2018 09:30:00 | 101 | 101 | 110   | GBX      | 10000		  |
	When I run the high profit rule
...
Scenario: Short just short orders within time window yields zero alerts
	Given I have the orders for a universe from 01/01/2018 to 03/01/2018 :
	| SecurityName | OrderId | PlacedDate          | BookedDate | AmendedDate | RejectedDate | CancelledDate | FilledDate          | Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	| Vodafone     | 0       | 01/01/2018 09:30:00 |            |             |              |               | 01/01/2018 09:30:00 | MARKET | SHORT       | GBX      |            | 10               | 1000           | 1000        |
	| Vodafone     | 1       | 01/01/2018 09:31:00 |            |             |              |               | 01/01/2018 09:31:00 | MARKET | SHORT      | GBX      |            | 12               | 1000           | 1000        |
	And With the intraday market data :
	| SecurityName | Epoch	             | Bid | Ask | Price | Currency | Volume      |
	| Vodafone     | 01/01/2018 09:30:00 | 101 | 101 | 110   | GBX      | 10000		  |
	When I run the high profit rule
