    ...
    public class RuleParameterLeadingTimespanCalculatorTests
    {
            ...
            var dto = new RuleParameterDto
                          {
                              Layerings = new[]
                                              {
                                                  new LayeringRuleParameterDto { WindowSize = TimeSpan.FromMinutes(9) }
                                              }
                          };
            ...
            var dto = new RuleParameterDto
                          {
                              Spoofings = new[]
                                              {
                                                  new SpoofingRuleParameterDto { WindowSize = TimeSpan.FromMinutes(8) }
                                              }
                          };
        ...
        public void LeadingTimespan_Returns_Value_When_TwoAlternatives_WashTrade_And_HighVolume()
        {
            ...
            var dto = new RuleParameterDto
                          {
                              WashTrades =
                                  new[] { new WashTradeRuleParameterDto { WindowSize = TimeSpan.FromMinutes(8) } },
                              HighVolumes = new[]
                                                {
                                                    new HighVolumeRuleParameterDto
                                                        {
