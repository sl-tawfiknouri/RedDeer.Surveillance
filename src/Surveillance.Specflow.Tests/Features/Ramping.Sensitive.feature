...
Scenario: Ramping with increasing prices matching increasing order fill values raises two alerts
...
Scenario: Ramping with increasing prices matching increasing order fill values raises seven alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
         | SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
         | Barclays     | 1       | 01/01/2019 13:50:00 | 01/01/2019 13:50:00   | Market | Buy       | GBX      |            | 100              | 500           | 500          |
         | Barclays     | 2       | 01/01/2019 13:51:00 | 01/01/2019 13:51:00   | Market | Buy       | GBX      |            | 101              | 500           | 500          |
...
Scenario: Ramping with oscilliating prices matching order fill values raises zero alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
		| Barclays     | 1       | 01/01/2019 13:50:00 | 01/01/2019 13:50:00   | Market | Buy       | GBX      |            | 100              | 500           | 500          |
...
Scenario: Ramping with increasing prices matching increasing order fill values raises zero alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
		...
		# ***** B U Y S *****
	Scenario: Ramping buys with increasing prices yields seven alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
		| Barclays     | 1       | 01/01/2019 13:50:00 | 01/01/2019 13:50:00   | Market | Buy       | GBX      |            | 100              | 500           | 500          |
		| Barclays     | 2       | 01/01/2019 13:51:00 | 01/01/2019 13:51:00   | Market | Buy       | GBX      |            | 101              | 500           | 500          |
	...
	Scenario: Ramping buys with oscilliating prices yields zero alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
		| Barclays     | 1       | 01/01/2019 13:50:00 | 01/01/2019 13:50:00   | Market | Buy        | GBX      |            | 100              | 500           | 500          |
		| Barclays     | 2       | 01/01/2019 13:51:00 | 01/01/2019 13:51:00   | Market | Buy        | GBX      |            | 101              | 500           | 500          |
	...
	Scenario: Ramping sells with decreasing prices yields seven alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
		| Barclays     | 1       | 01/01/2019 13:50:00 | 01/01/2019 13:50:00   | Market | Sell        | GBX      |            | 100              | 500           | 500          |
	...
	Scenario: Ramping sells with oscilliating prices yields zero alerts
		...
		# ***** C O V E R S *****
			...
			Scenario: Ramping covers with increasing prices yields seven alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
	...
	Scenario: Ramping covers with oscilliating prices yields zero alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
		| Barclays     | 1       | 01/01/2019 13:50:00 | 01/01/2019 13:50:00   | Market | Cover      | GBX      |            | 100              | 500           | 500          |
		| Barclays     | 2       | 01/01/2019 13:51:00 | 01/01/2019 13:51:00   | Market | Cover      | GBX      |            | 101              | 500           | 500          |
	...
	Scenario: Ramping shorts with decreasing prices yields seven alerts
		Given I have the orders for a universe from 01/01/2019 to 01/01/2019 :
		| SecurityName | OrderId | PlacedDate			| FilledDate			| Type   | Direction | Currency | LimitPrice | AverageFillPrice | OrderedVolume | FilledVolume |
		| Barclays     | 1       | 01/01/2019 13:50:00 | 01/01/2019 13:50:00   | Market | Short        | GBX      |            | 100              | 500           | 500          |
