...
namespace DomainV2.Files
{
    public class TradeFileCsvToOrderMapper : ITradeFileCsvToOrderMapper
    {
        ...
        private TradeFileCsv MapTradeFields2(DealerOrder trad, TradeFileCsv csv)
        {
            ...
            csv.DealerOrderPlacedDate = trad.PlacedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.DealerOrderBookedDate = trad.BookedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.DealerOrderAmendedDate = trad.AmendedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.DealerOrderRejectedDate = trad.RejectedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.DealerOrderCancelledDate = trad.CancelledDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.DealerOrderFilledDate = trad.FilledDate?.ToString("yyyy/MM/dd hh:mm:ss");
            ...
            csv.DealerOrderOptionExpirationDate = trad.OptionStrikePrice?.ToString("yyyy/MM/dd hh:mm:ss");
        ...
        private TradeFileCsv MapOrderFields(Order order, TradeFileCsv csv)
        {
            ...
            csv.OrderPlacedDate = order.PlacedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.OrderBookedDate = order.BookedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.OrderAmendedDate = order.AmendedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.OrderRejectedDate = order.RejectedDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.OrderCancelledDate = order.CancelledDate?.ToString("yyyy/MM/dd hh:mm:ss");
            csv.OrderFilledDate = order.FilledDate?.ToString("yyyy/MM/dd hh:mm:ss");
