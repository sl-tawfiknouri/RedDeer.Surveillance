...
namespace Surveillance.DataLayer.Aurora.Analytics
{
    public class RuleAnalyticsAlertsRepository : IRuleAnalyticsAlertsRepository
    {
        ...
        private const string CreateSql = @"
            INSERT INTO RuleAnalyticsAlerts(SystemProcessOperationId, CancelledOrderAlertsRaw, CancelledOrderAlertsAdjusted, HighProfitAlertsRaw, HighProfitAlertsAdjusted, HighVolumeAlertsRaw, HighVolumeAlertsAdjusted, LayeringAlertsRaw, LayeringAlertsAdjusted, MarkingTheCloseAlertsRaw, MarkingTheCloseAlertsAdjusted, SpoofingAlertsRaw, SpoofingAlertsAdjusted, WashTradeAlertsRaw, WashTradeAlertsAdjusted, FixedIncomeHighProfitAlertsAdjusted, FixedIncomeHighProfitAlertsRaw, FixedIncomeHighVolumeIssuanceAlertsAdjusted, FixedIncomeHighVolumeIssuanceAlertsRaw, FixedIncomeWashTradeAlertsRaw, FixedIncomeWashTradeAlertsAdjusted, RampingAlertsRaw, RampingAlertsAdjusted) VALUES(@SystemProcessOperationId, @CancelledOrderAlertsRaw, @CancelledOrderAlertsAdjusted, @HighProfitAlertsRaw, @HighProfitAlertsAdjusted, @HighVolumeAlertsRaw, @HighVolumeAlertsAdjusted, @LayeringAlertsRaw, @LayeringAlertsAdjusted, @MarkingTheCloseAlertsRaw, @MarkingTheCloseAlertsAdjusted, @SpoofingAlertsRaw, @SpoofingAlertsAdjusted, @WashTradeAlertsRaw, @WashTradeAlertsAdjusted, @FixedIncomeHighProfitAlertsAdjusted, @FixedIncomeHighProfitAlertsRaw, @FixedIncomeHighVolumeIssuanceAlertsAdjusted, @FixedIncomeHighVolumeIssuanceAlertsRaw, @FixedIncomeWashTradeAlertsRaw, @FixedIncomeWashTradeAlertsAdjusted, @RampingAlertsRaw, @RampingAlertsAdjusted);";
