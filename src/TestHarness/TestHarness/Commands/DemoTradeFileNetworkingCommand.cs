namespace TestHarness.Commands
{
    ...
    public class DemoTradeFileNetworkingCommand : ICommand
    {
        ...
        public bool Handles(string command)
        {
            ...
            var hasStopDemoTradeFileCommandSegment =
                command.ToLowerInvariant().Contains("stop demo trade networking file");
            ...
            var fileSegment = Regex.Replace(
                command,
                "run demo trade networking file ",
                string.Empty,
        ...
        public void Run(string command)
        {
            ...
            if (hasDemoTradeFileCommandSegment) this.RunDemo(command);
