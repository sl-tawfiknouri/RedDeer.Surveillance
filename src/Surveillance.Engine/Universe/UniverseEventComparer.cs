namespace Surveillance.Engine.Rules.Universe
{
    ...
    {
        private readonly Dictionary<UniverseStateEvent, int> _priority = new Dictionary<UniverseStateEvent, int>
                                                                             {
        ...
        public int Compare(IUniverseEvent x, IUniverseEvent y)
        {
            ...
            var hasX = this._priority.ContainsKey(x.StateChange);
            var hasY = this._priority.ContainsKey(y.StateChange);
            ...
            var xPriority = this._priority[x.StateChange];
            var yPriority = this._priority[y.StateChange];

            if (xPriority == yPriority) return 0;
